...
use omnitron_common::{TargetOptions, TargetWebAdminOptions, OmnitronConfig, OmnitronError};
...
pub async fn populate_db(
    ...
    _config: &mut OmnitronConfig,
) -> Result<(), OmnitronError> {
    use sea_orm::ActiveValue::Set;
    use omnitron_db_entities::{Recording, Session};
