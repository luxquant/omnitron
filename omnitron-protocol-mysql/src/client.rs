...
use bytes::BytesMut;
use omnitron_common::{configure_tls_connector, TargetMySqlOptions, TlsMode};
use omnitron_database_protocols::io::Decode;
use omnitron_database_protocols::mysql::protocol::auth::AuthPlugin;
use omnitron_database_protocols::mysql::protocol::connect::{Handshake, HandshakeResponse, SslRequest};
use omnitron_database_protocols::mysql::protocol::response::ErrPacket;
