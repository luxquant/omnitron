...
if (localStorage.omnitronMenuLocation) {
    position = JSON.parse(localStorage.omnitronMenuLocation)
...
function stopDragging () {
    dragging = false
    savedPosition = position
    localStorage.omnitronMenuLocation = JSON.stringify(position)
}
