...
pub struct OmnitronClaims {
    // This uses the "omnitron_roles" claim from OIDC
    pub omnitron_roles: Option<Vec<String>>,
}

impl AdditionalClaims for OmnitronClaims {}

pub struct SsoResult {
    pub token: CoreIdToken,
    pub claims: CoreIdTokenClaims,
    pub userinfo_claims: Option<UserInfoClaims<OmnitronClaims, CoreGenderClaim>>,
}
...
impl SsoClient {
    ...
    pub async fn finish_login(
        ...
        let userinfo_claims: Option<UserInfoClaims<OmnitronClaims, CoreGenderClaim>> =
