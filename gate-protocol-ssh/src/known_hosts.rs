...
use gate_db_entities::KnownHost;
...
impl KnownHosts {
  ...
  pub async fn validate(&mut self, host: &str, port: u16, key: &PublicKey) -> Result<KnownHostValidationResult, sea_orm::DbErr> {
  ...
  pub async fn trust(&mut self, host: &str, port: u16, key: &PublicKey) -> Result<(), sea_orm::DbErr> {
