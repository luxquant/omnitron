...
pub fn admin_api_app(services: &Services) -> impl IntoEndpoint {
  let api_service =
    OpenApiService::new(crate::api::get(), "Omnitron admin API", env!("CARGO_PKG_VERSION")).server("/@omnitron/admin/api");
  ...
  Route::new()
    ...
    .at("/recordings/:id/cast", crate::api::recordings_detail::api_get_recording_cast)
    .at(
