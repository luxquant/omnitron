...
use omnitron_core::{SessionSnapshot, State};
...
impl Api {
  ...
  #[oai(path = "/sessions", method = "delete", operation_id = "close_all_sessions")]
...
#[handler]
pub async fn api_get_sessions_changes_stream(ws: WebSocket, state: Data<&Arc<Mutex<State>>>) -> impl IntoResponse {
