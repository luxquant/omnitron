...
pub static SUCCESS: Lazy<colored::ColoredString> = Lazy::new(|| "[OMNITRON]".green());
pub static FAIL: Lazy<colored::ColoredString> = Lazy::new(|| "[OMNITRON]".red());
pub static WARN: Lazy<colored::ColoredString> = Lazy::new(|| "[OMNITRON]".yellow());
