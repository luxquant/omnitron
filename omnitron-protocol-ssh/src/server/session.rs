            ...
            RCEvent::ConnectionError(error) => {
                ...
                match error {
                    ConnectionError::HostKeyMismatch {
                        ...
                        .await?;
                        self.emit_service_message(
                        "you can remove the old key in the Omnitron management UI and try again",
                    )
                    .await?;
                    }
                    error => {
