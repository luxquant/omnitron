...
use gate_common::auth::{AuthCredential, AuthResult, AuthSelector, CredentialKind};
use gate_common::helpers::rng::get_crypto_rng;
use gate_common::{Secret, TargetMySqlOptions, TargetOptions};
use gate_core::{authorize_ticket, consume_ticket, OmnitronServerHandle, Services};
use gate_database_protocols::io::{BufExt, Decode};
use gate_database_protocols::mysql::protocol::auth::AuthPlugin;
use gate_database_protocols::mysql::protocol::connect::{AuthSwitchRequest, Handshake, HandshakeResponse};
use gate_database_protocols::mysql::protocol::response::{ErrPacket, OkPacket, Status};
use gate_database_protocols::mysql::protocol::text::Query;
use gate_database_protocols::mysql::protocol::Capabilities;
use rand::Rng;
