...
use bytes::BytesMut;
use gate_common::{configure_tls_connector, TargetMySqlOptions, TlsMode};
use gate_database_protocols::io::Decode;
use gate_database_protocols::mysql::protocol::auth::AuthPlugin;
use gate_database_protocols::mysql::protocol::connect::{Handshake, HandshakeResponse, SslRequest};
use gate_database_protocols::mysql::protocol::response::ErrPacket;
